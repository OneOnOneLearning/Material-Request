 ...
 * STRUCTURE:
 * STATE_CODE → GRADE → {
 *   math: { type: "skills" | "standards", items: [...] },
 *   ela: { type: "skills" | "standards", items: [...] }
 * }
 *
 ...
 *   { code: "5.OA.1", desc: "Full description of the standard" }
 */
...
const STANDARDS = {
    ...
    FL: {
        ...
        // 6th Grade
        6: {
            math: { type: "standards", items: [] },
            ela: { type: "standards", items: [] }
        },
        // 7th Grade
        7: {
            math: { type: "standards", items: [] },
